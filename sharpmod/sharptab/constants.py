...
PARAM_REGISTRY: Dict[str, ParamSpec] = {
    ...
    "vgp": ParamSpec(
        name="vgp",
        label="VGP",
        input_units="J/kg, kt, m",
        output_units="m/s^2",
        phys_min=0.0,
        phys_max=3.0,
        tolerance=0.01,
        reference="Rasmussen & Wilhelmson (1983), vorticity generation "
        "parameter definition used in severe-storm sounding diagnostics",
        formula="sqrt(SBCAPE) * (0-4 km bulk shear in m/s / 4000 m)",
    ),
    "wbz_height": ParamSpec(
        name="wbz_height",
        label="WBZ Height",
        input_units="wet-bulb temperature, height",
        output_units="m AGL",
        phys_min=0.0,
        phys_max=10000.0,
        tolerance=1.0,
        reference="standard wet-bulb-zero melting-level height",
        formula="height AGL of the first 0 degrees C wet-bulb isotherm",
    ),
    "ncape": ParamSpec(
        name="ncape",
        label="NCAPE",
